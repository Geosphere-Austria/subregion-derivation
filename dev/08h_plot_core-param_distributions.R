# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
# plot distribution of progenitor variables
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
...
uh_col <- tribble(
  ...
  -1, -1, rgb(0.4, 0.4, 0.4),
  1, 5, rgb(0.33, 0.66, 0.40),
  2, 1, rgb(0.77, 0.31, 0.32),
  3, 6, rgb(0.27, 0.42, 0.65),
  4, 3, rgb(0.36, 0.31, 0.56),
  5, 7, rgb(0.39, 0.71, 0.81),
  6, 4, rgb(0.80, 0.73, 0.46),
  7, 2, rgb(0.67, 0.61, 0.87)
)
...
basepar <- read_ncdf("dat/interim/07_cluster_evaluation/base_params.nc") |>
  convert_stars() |>
  mutate(RR = RR * 365)
...
ggsave("plt/core_param_distribution.png", pp, width = 180, height = 200, units = "mm", dpi = 300)
